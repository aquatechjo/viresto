  ...
  openMenu: 'Open sidebar menu',
    ...
    documents: {
      ...
      linkPanel: {
        ...
        subtitle: 'Optional, but it helps organize the archive and search later.',
      ...
      empty: {
        title: 'No documents',
        first: 'Upload the first document to start organizing the office archive.',
      ...
      messages: {
        ...
        archivedUploadBlocked: 'Cannot upload a document for an archived client',
        planLimitFallback:
        ...
        archivedDeleteBlocked: 'Cannot delete a document linked to an archived client',
      },
    },
    ...
    appointments: {
      ...
      messages: {
        ...
        archivedEditBlocked: 'Cannot edit an appointment linked to an archived client',
        archivedCreateBlocked: 'Cannot create an appointment for an archived client',
        archivedDeleteBlocked: 'Cannot delete an appointment linked to an archived client',
        archivedLinkBlocked: 'Cannot create or link an appointment to an archived client.',
        ...
        deleteUnexpectedError: 'An error occurred while deleting the appointment',
    ...
    team: {
      ...
      form: {
        title: 'Add user',
        subtitle: 'The new user will sign in using their email and temporary password.',
      ...
      unauthorized: {
        ...
        subtitle: 'This page is dedicated to managing office users and their permissions.',
      ...
      planLimit: {
        ...
        billing: 'View subscription',
        close: 'Close',
        fallback: 'You have reached the user limit allowed by your current plan.',
      },
      messages: {
