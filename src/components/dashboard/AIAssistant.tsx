...
const TEXT = {
  ar: {
    ...
    placeholder: "اسأل عن القضايا أو المواعيد أو الموكلين...",
    send: "إرسال",
    ...
    emptyText: "اسأل عن ملخص المكتب أو القضايا أو المواعيد القادمة.",
    hint: "Enter للإرسال، وShift + Enter لسطر جديد",
    suggestions: [
      "لخص وضع المكتب الحالي",
      "ما المواعيد القادمة؟",
  ...
  en: {
    ...
    emptyText: "Ask about the office summary, cases, or upcoming appointments.",
    hint: "Enter to send, Shift + Enter for a new line",
    suggestions: [
      "Summarize the current office status",
